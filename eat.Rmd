...
## Conclusion
In conclusion, after seeing all the data graphs and data   sheets with the fisher's exact test,i can disagree with   the hypothesis that states there is no diffrence between   the races with eating out.  
